            ...
            <div class="col-xl-5 col-md-6 col-lg-4 d-none d-lg-block">
                <div class="wsus__search">
                    <form action="{{route('products.index')}}">
                        ...
                        <button type="submit"><i class="far fa-search sch"></i></button>
                    </form>
                </div>
            </div>
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        <li><a href="{{route('user.wishlist.index')}}"><i class="fal fa-heart"
                                    style="color: #3b3b3b;"></i><span id="wishlist_count">
                                    @if (auth()->check())
                        ...
                        <li><a class="wsus__cart_icon" href="#"><i class="fal fa-heart"
                                    style="color: #3b3b3b;"></i><span
